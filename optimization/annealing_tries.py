...
# Algorithm for the Simulated Annealing method. Add a For loop to compare results in different tries
...
# Annealing function
def simulated_annealing(dist_matrix, initial_temperature=10000, cooling_rate=0.9995, iterations=100000):
...
# Run the Annealing algorithm several times
number_of_tries = 10
